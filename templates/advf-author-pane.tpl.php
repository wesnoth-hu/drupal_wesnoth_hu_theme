...
<div class="author-pane <?php print $online_status_class?>">
 <div class="author-pane-inner">
    ...
    <div class="author-pane-section author-pane-general">
      ...
      <div class="author-pane-line author-profile">
        <?php /* Joined */ ?>
        <?php if (!empty($joined)): ?>
        ...
        <?php /* Location */ ?>
        <?php if (!empty($account->profile_user_from)): ?>
          <div class="author-location">
            <span class="author-pane-label"><?php print t('Location'); ?>:</span> <?php print $account->profile_user_from;  ?>
          </div>
        <?php endif; ?>
    ...
    <div class="author-pane-section author-pane-contact">
      ...
      <?php /* Website */ ?>
      <?php if (!empty($account->profile_user_website)): ?>
        <div class="author-pane-line author-pane-link-line author-website">
          <a class="author-pane-link" href="<?php print url($account->profile_user_website) ?>"><span>Website</span></a>
        </div>
      <?php endif; ?>
